...
HD_PWD='C:/Users/ivanv/Documents/Barbosa/project_4/project_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tarea4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tarea4.tcl -notrace
