...
HD_PWD='C:/Users/ivanv/Documents/Barbosa/project_4/project_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tarea4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tarea4.tcl
